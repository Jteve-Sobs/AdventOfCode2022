...
namespace AdventOfCode1101
{
    ...
    internal class Monkey
    {
        ...
        public void SetItems(string line)
        {
            ...
            {
                Items.Add(Convert.ToInt32(items[i].Value));
            }
        }
        ...
        public Monkey(int id, List<int> items, char operation, int test, int testTrue, int testFalse)
        {
            ID = id;
            Items = items;
            Operation = operation;
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                foreach (var monkey in monkeys)
                {
                    ...
                    for (int j = 0; j < monkey.Items.Count; j++)
                    {
                        ...
                        monkey.Items[j] = Convert.ToInt32(monkey.Items[j]) / 3;
            ...
            // Assert for input1
            //Assert.AreEqual(10605, monkeyBusiness, "Result is not correct");
